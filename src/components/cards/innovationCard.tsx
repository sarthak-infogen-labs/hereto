...
export default function Card({
    ...
    return (
        ...
        {/* Overlay content */}
        <div className="relative z-10 h-full w-full bg-[#070010]/15 flex p-5 flex-col justify-between border border-[#322B43] group-hover/card:border-[#00C4CC] group-hover/card:bg-[#070010]/75 rounded-xl transition-all duration-600">
          ...
          <div className="px-[18px] ">
                <p className="text-[#AC9CC0] text-[16px] leading-[24px] font-normal flex gap-2 items-center group-hover/card:text-[#00C4CC] transition-all duration-600">
                    <span>Explore <b>{linkText}</b></span>
                    <ChevronRight size={16} className="text-[#AC9CC0]" strokeWidth={2}></ChevronRight>
                </p>
        </div>
        </div>
      </div>
